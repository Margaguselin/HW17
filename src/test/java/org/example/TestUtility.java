...
public class TestUtility {
    public static String getRandomCocktailResponseAsString(){
        return  "{\n" +
                "  \"drinks\": [\n" +
                "    {\n" +
                "      \"idDrink\": \"12130\",\n" +
    ...
    public static String getCocktailsByNameResponseAsString(){
        return "{\n" +
                "  \"drinks\": [\n" +
                "    {\n" +
                "      \"idDrink\": \"1107\",\n" +
    ...
    public static String getCocktailsByFirstLetterResponseAsString(){
        return  "{\n" +
                "    \"drinks\": [\n" +
                "        {\n" +
                "            \"idDrink\": \"17222\",\n" +
